                    ...
                    <div class="row align-items-end">
                        <div class="col-xl-5 col-lg-6">
                            <div class="section-area-2">
                                <h2 class="section-title mb-50">Universidades<span>reconocidas </span></h2>
                            </div>
                        </div>
                        <div class="col-xl-7 col-lg-6">
                            <div class="h2_course-tab mb-40">
                                <ul class="nav nav-pills" id="pills-tab" role="tablist">
                                    ...
                                    <li class="nav-item" role="presentation">
                                      <button class="nav-link" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="false">La Universidad de Buenos Aires </button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                      <button class="nav-link" id="pills-contact-tab" data-bs-toggle="pill" data-bs-target="#oferta" type="button" role="tab" aria-controls="pills-contact" aria-selected="false">
Carreras de grado ofertadas 
</button>
                                    </li>
    ...
    <div class="col-xl-12 col-lg-12 col-md-12">
        <div class="h2_course-item mb-30">
            <div class="h2_course-item-img">
                <a href="#"><img src="https://statics.forbesargentina.com/2021/08/61268f0868562.jpg" alt=""></a>
            </div>
            <div class="h2_course-content">
                ...
                <h5 class="h2_course-content-title"><a href="">Universidad de Buenos Aires</a></h5>
               
                <p class="h2_course-content-text">
La Universidad de Buenos Aires (UBA) es una universidad pública argentina fundada el 12 de agosto de 1821 con sede en la Ciudad de Buenos Aires. 
La Universidad de Buenos Aires tiene una larga tradición de excelencia académica. Ha sido reconocida por su contribución a la ciencia, la tecnología y la cultura, la UBA actualmente cuenta con 13 facultades en las que se dictan 87 carreras de grado lo que le ha permitido en 2021 posicionarse en el puesto 66 entre las mejores universidades a nivel mundial, contando con los centros de estudios más prestigiosos de América y del mundo.
En los pasillos de la UBA se destacan los cinco ganadores argentinos del Premio Nobel que han sido estudiantes y/o profesores de esta universidad. La UBA es una institución fundamental para la educación y la investigación. Es una fuente de orgullo para el país y un referente para el mundo.

                </p>
               <a href="#" class="header-btn theme-btn theme-btn-medium">Oferta</a>
            </div>
                           ...
                           <div class="tab-pane fade" id="oferta" role="tabpanel" aria-labelledby="pills-profile-tab" tabindex="0">
    ...
    <table border="1">
        <thead>
            <tr>
                ...
                <th>Nombre</th>
                <th>Estado</th>
                <th>Tipo de Oferta Académica</th>
                <th>Carrera</th>
            </tr>
        </thead>
        <tbody>
            @foreach($universidades as $universidad)
                <tr>
                    ...
                    <td>{{ $universidad->tipo_oferta_academica }}</td>
