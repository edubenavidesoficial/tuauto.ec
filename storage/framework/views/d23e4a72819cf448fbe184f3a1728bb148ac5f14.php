<?php echo $__env->make('web.layout.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <div class="video-background">
        <video autoplay muted loop>
            <source src="assets/video/Video_Innova.mov#t=0,10" type="video/mp4">
            Tu navegador no admite el elemento de video.
        </video>
    </div>
    <button class="more-info-button"><h3 class="section-title mb-50">Estudia en las mejores universidades de Argentina</h3></button>
</section>
            <!-- banner area start 
            <section class="h2_banner-area">
        ...
        <div class="row">
            <div class="col-12">
                <div class="section-area-2 small-section-area-2 text-center">
                    <h2 class="section-title mb-50">Explora Universidades para Estudiar en <span>Argentina <img src="assets/img/banner/2/line.png" alt=""></span></h2>
                </div>
            </div>
        </div>
        <div class="row">
...
<?php echo $__env->make('web.layout.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
   <?php /**PATH /home/innovaeducations/public_html/resources/views/welcome.blade.php ENDPATH**/ ?>